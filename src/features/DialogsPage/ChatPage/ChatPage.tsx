...
import {useLazyGetFriendMessageQuery, useSendFriendMessageMutation} from "features/DialogsPage/dialogsPage.api";
import {dialogsPageActions} from "features/DialogsPage/dialogsSlice";
import {Message} from "features/DialogsPage/ChatPage/Message/Message";
...
export const ChatPage = React.memo(() => {
    ...
    useEffect(() => {
        ...
        return () => {
            dispatch(dialogsPageActions.resetState())
        }
